...
describe('test Menu and MenuItem component', () => {
  ...
  it('should render correct Menu and MenuItem based on default props', () => {
    ...
    expect(menuElement).toHaveClass('springwind-menu');
  ...
  it('should render vertical mode when mode is set to horizontal and should show dropdown item when click dropMenu', () => {
    cleanup();
